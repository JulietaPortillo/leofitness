...
<head>
    ...
    <link href="{{ URL::asset('resources/plugins/bootstrap/css/bootstrap.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/ionicons/css/ionicons.min.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet"/>
    <!-- END CORE FRAMEWORK -->

    <!-- BEGIN PLUGIN STYLES -->
    <link href="{{ URL::asset('resources/plugins/animate/animate.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/morris/morris.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/bootstrap-slider/css/slider.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/datepicker/css/bootstrap-datepicker.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/rickshaw/rickshaw.min.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/bootstrapValidator/bootstrapValidator.min.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/sweetalert/sweetalert.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/bootstrap-select/css/bootstrap-select.min.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/plugins/bootstrap-tokenfield/css/bootstrap-tokenfield.min.css') }}" rel="stylesheet"/>
    <!-- END PLUGIN STYLES -->

    <!-- BEGIN THEME STYLES -->
    <link href="{{ URL::asset('resources/css/material.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/css/style.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/css/plugins.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/css/helpers.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/css/responsive.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/css/mystyle.css') }}" rel="stylesheet"/>
    <link href="{{ URL::asset('resources/css/print.css') }}" media="print" rel="stylesheet"/>
    <!-- END THEME STYLES -->
    ...
    <div class="leftside hidden-print">
        <div class="sidebar">
            ...
            <ul class="nav-sidebar">
                ...
                @can(['manage-gymie','manage-members','view-member'])
                <li class="nav-dropdown {{ Utilities::setActiveMenu('members*',true) }}">
                    ...
                    <ul>
                        ...
                        @can(['manage-gymie','manage-members','add-member'])
                ...
                @can(['manage-gymie','manage-payments','view-payment'])
                <li class="nav-dropdown {{ Utilities::setActiveMenu('payments*',true) }}">
                    ...
                    <ul>
                        ...
                        @can(['manage-gymie','manage-payments','add-payment'])
                ...
                @can(['manage-gymie','manage-subscriptions','view-subscription'])
                <li class="nav-dropdown {{ Utilities::setActiveMenu('subscriptions*',true) }}">
                    ...
                    <ul>
                        <li class="{{ Utilities::setActiveMenu('subscriptions/all') }}"><a href="{{ action('SubscriptionsController@index') }}">All
                                Subscriptions</a></li>
                        @can(['manage-gymie','manage-subscriptions','add-subscription'])
            ...
            <!-- <li class="nav-dropdown {{-- Utilities::setActiveMenu('reports*',true) --}}">
                ...
                @can(['manage-gymie','manage-invoices','view-invoice'])
                ...
                @can(['manage-gymie','manage-expenses','view-expense'])
                ...
                @can(['manage-gymie','manage-plans','view-plan'])
                ...
                @can(['manage-gymie','manage-settings'])
...
<!-- BEGIN CORE PLUGINS -->
<script src="{{ URL::asset('resources/plugins/jquery-1.11.1.min.js') }}" type="text/javascript"></script>
<script src="{{ URL::asset('resources/plugins/bootstrap/js/bootstrap.min.js') }}" type="text/javascript"></script>
<script src="{{ URL::asset('resources/plugins/pace/pace.min.js') }}" type="text/javascript"></script>
<script src="{{ URL::asset('resources/plugins/slimScroll/jquery.slimscroll.min.js') }}" type="text/javascript"></script>
<script src="{{ URL::asset('resources/plugins/bootstrap-select/js/bootstrap-select.min.js') }}" type="text/javascript"></script>
<script src="{{ URL::asset('resources/plugins/bootstrap-tokenfield/bootstrap-tokenfield.min.js') }}" type="text/javascript"></script>
<script src="{{ URL::asset('resources/plugins/sweetalert/sweetalert.min.js') }}" type="text/javascript"></script>
<script src="{{ URL::asset('resources/js/core.js') }}" type="text/javascript"></script>
<!-- END CORE PLUGINS -->

<!-- datepicker -->
<script src="{{ URL::asset('resources/plugins/bootstrap-daterangepicker/moment.min.js') }}" type="text/javascript"></script>
<script src="{{ URL::asset('resources/plugins/bootstrap-daterangepicker/daterangepicker.js') }}" type="text/javascript"></script>

<!-- counter -->
<script src="{{ URL::asset('resources/plugins/jquery-countTo/jquery.countTo.js') }}" type="text/javascript"></script>

<!-- datepicker -->
<script src="{{ URL::asset('resources/plugins/datepicker/js/bootstrap-datepicker.min.js') }}" type="text/javascript"></script>

<!--validator-->
<script src="{{ URL::asset('resources/plugins/bootstrapValidator/bootstrapValidator.min.js') }}" type="text/javascript"></script>
...
<!-- gymie -->
<script src="{{ URL::asset('resources/js/gymie.js') }}" type="text/javascript"></script>
