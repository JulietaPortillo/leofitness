    ...
    <div class="col-md-12">
        <div class="panel no-border">
            <div class="panel-title">
                <div class="panel-head font-size-20">Ingrese detalles del recibo</div>
            </div>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('additional_fees','Cargos adicionales') !!}
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            {!! Form::label('subscription_amount','Cargo de subscripcion') !!}
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-money"></i></div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            {!! Form::label('discount_amount','Cantidad de decuento') !!}
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-money"></i></div>
