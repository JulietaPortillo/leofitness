...
<div class="wrapper animated fadeInDown">
    <div class="panel overflow-hidden">
        <div class="bg-grey-500 padding-40 no-margin-bottom font-size-5 color-white text-center text-uppercase">
            <img src="{{ asset('assets/img/web/logo.png') }}" alt="Logo" style="width: 50%; height: auto;">
        </div>
        @if (count($errors) > 0)
